...
const Register = () => {
  ...
  return (
    ...
    <div className="registerUi d-flex align-items-center">
      ...
      <div className="form-signup w-100 m-auto">
        <div className="text-center">
          ...
          <div className="form-floating">
            <input onChange={handleUsername} type="text" className="form-control" name="username" placeholder="Name"/>
          ...
          <button onClick={handleRegister} className="btn btn-primary w-100 py-2">Register</button>
